...
.skill-item {
  width: 100%;
  /* Make each skill item span the full width */
  margin-bottom: 20px;
  text-align: left;
}
...
.pagination {
  ...
  --bs-pagination-focus-box-shadow: 0 0 0 0.25rem rgba(88, 70, 170, 0.25);
  --bs-pagination-active-color: #fff;
  --bs-pagination-active-bg: #3b6db8;
  --bs-pagination-active-border-color: #3b6db8;
